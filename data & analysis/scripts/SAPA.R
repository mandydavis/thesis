...
ORVIS_scores_test <- scoreItems(keys = ItemLists[451:458], items = SAPA_500, impute = "none") # need the char2numeric?
...
sb <- statsBy(data = ORVIS_an, group = ORVIS_an$country, cors = TRUE)
